...
namespace DankGame.Controller
{
	...
	public class Game1 : Game
	{
		...
		protected override void LoadContent()
		{
			...
			Texture2D playerTexture = Content.Load<Texture2D>("Texture/Penguin");
			playerAnimation.Initialize(playerTexture, Vector2.Zero, 128, 128, 2, 100, Color.White, 1f, true);
			...
			bgLayer2.Initialize(Content, "Texture/myBackground2", GraphicsDevice.Viewport.Width, -2);

			mainBackground = Content.Load<Texture2D>("Texture/KirbyBackground");

			enemyTexture = Content.Load<Texture2D>("Animation/Bronco Burt");
		...
		private void AddEnemy()
		{
			...
			enemyAnimation.Initialize(enemyTexture, Vector2.Zero, 100, 100, 2, 100, Color.White, 1f, true);
